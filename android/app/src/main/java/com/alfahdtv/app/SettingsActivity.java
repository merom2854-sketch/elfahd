...
public final class SettingsActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        body.addView(action("\u2708  \u0642\u0646\u0627\u0629 \u0627\u0644\u0641\u0647\u062f \u0639\u0644\u0649 \u062a\u064a\u0644\u064a\u062c\u0631\u0627\u0645",v->telegram()));
    ...
    private void telegram(){startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("https://t.me/elfahd_tv")));}
