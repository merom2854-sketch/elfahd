...
const CONTENT_FILE = path.join(DATA_DIR, 'manual-content.json');
...
const baseConfig = Object.freeze({
  ...
  minimumVersionCode: 1, latestVersionCode: 28, latestVersionName: '3.6.1',
  apkUrl: 'https://github.com/merom2854-sketch/elfahd/releases/download/v3.6.1/Al-Fahd-TV-3.6.1.apk',
